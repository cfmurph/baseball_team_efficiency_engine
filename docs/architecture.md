...
See [adr/0001-shared-artifact-contract.md](adr/0001-shared-artifact-contract.md) for the locked layout and [shared_artifacts.md](shared_artifacts.md) for operator setup.
