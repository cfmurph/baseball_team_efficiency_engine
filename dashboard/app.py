...
from src.baseball_analytics.dashboard_utils import (
    ...
    apply_plotly_dark_layout as _apply_layout,
    has_name_collision as _has_name_collision,
    player_id_columns_for_name_collisions as _player_id_columns_for_name_collisions,
    render_plotly_chart as _render_plotly_chart,
    slider_max as _get_slider_max,
)
...
def _chart(fig, height: int = 400) -> None:
    ...
    _render_plotly_chart(fig, st.plotly_chart, height=height)
...
_slider_max = _get_slider_max(all_years, _current_year)
...
def page_player_explorer() -> None:
    ...
    has_name_collision = _has_name_collision(filt)
    id_col = _player_id_columns_for_name_collisions(filt)
...
def page_team_profile() -> None:
    ...
    if players is not None:
        ...
        if not roster.empty:
            roster_id = _player_id_columns_for_name_collisions(roster)
