...
from src.baseball_analytics.dashboard_utils import (
    ...
    id_columns_for_name_collisions as _id_columns_for_name_collisions,
    render_chart as _render_chart,
    scale_payroll as _scale_payroll,
    slider_max as _compute_slider_max,
)
...
def _chart(fig, height: int = 400) -> None:
    ...
    _render_chart(st, fig, height=height)
...
_slider_max = _compute_slider_max(all_years, _current_year)
...
def page_player_explorer() -> None:
    ...
    id_col = _id_columns_for_name_collisions(filt)
...
def page_team_profile() -> None:
    ...
    if players is not None:
        ...
        if not roster.empty:
            roster_id = _id_columns_for_name_collisions(roster)
